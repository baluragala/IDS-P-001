...
namespace IPAPPM.Web.Portal.Controllers
{
    ...
    public class CommonPaperTermController : Controller
    {
        ...
        public ActionResult Index(int? page)
        {
            ...
            return View(db.tbl_CommonTerms.Where(c=>c.TermType==1).OrderBy(t=>t.Title).ToPagedList(pageNumber,pageSize));
        }
        ...
        public String DeleteConfirmed(int id)
        {
            try
            {
                ...
                db.SaveChanges();
                return "Common Paper Term deleted successfully";
            }
            catch (Exception ex)
            {
                return "Common Paper Term Cannot deleted. May be due to existing references or violation";
            }
        }
